...
""" demonstrating python in-built functions"""
...
print()
print("Returning True if all items in an iterable object are true")
print("_"*40)
print('all', all(''))   # True
...
print()
print("Returning  True if any item in an iterable object is true")
print("_"*40)
print('any', any([]))       # False
...
print()
print()
print("Returns the boolean value of the specified object")
print("_"*40)
...
print()
print("Returns an array of bytes")
print("_"*40)
...
print()
print("Returns True if the specified object is callable, otherwise False")
print("_"*40)
...
print()
print("# Returns a character from the specified Unicode code.")
print("_"*40)
...
print()
print("Deletes the specified attribute (property or method) from the specified object")
print("_"*40)
class Person:
    name = 'Sumeet'
    city = 'Bangalore'
